...
public class ControllerRegistrar {
    ...
    void Registrar(ActionEvent event) {
     ...
     // Obtener la lista de restaurantes ya cargada
        Cliente cliente = new Cliente();
        ArrayList<Restaurante> restaurantes = cliente.cargarRestaurantes("Restaurantes.json"); // Asegúrate de proporcionar la ruta correcta al archivo JSON de los restaurantes
        ...
        Cliente nuevoCliente = new Cliente(txtUsuario.getText(), txtcontrasena.getText(),
                ...
                null, "Restaurantes.json"); // Asegúrate de proporcionar la ruta correcta al archivo JSON de los restaurantes
